...
class Param:
    def __init__(self):
        ...
        self.mem_heads = 4
        self.mem_knn = 32
        self.mem_share_values = True
        self.mem_shuffle_indices = False
        self.mem_shuffle_query = False
        self.mem_modulo_size = -1
        self.mem_keys_type = "uniform"
        self.mem_n_keys = 512
        self.mem_keys_normalized_init = False
        self.mem_keys_learn = True
        self.mem_use_different_keys = True
        self.mem_query_detach_input = False
        self.mem_query_layer_sizes = "0,0"
        self.mem_query_kernel_sizes = ""
        self.mem_query_bias = True
        self.mem_query_batchnorm = True
        self.mem_query_net_learn = True
        self.mem_query_residual = False
        self.mem_multi_query_net = False
        self.mem_value_zero_init = False
        self.mem_normalize_query = False
        self.mem_temperature = 1
        self.mem_score_softmax = True
        self.mem_score_subtract = ""
        self.mem_score_normalize = False
        self.mem_input_dropout = 0
        self.mem_query_dropout = 0
        self.mem_value_dropout = 0
...
class Block(nn.Module):
    def __init__(self, n_ctx, config, scale=False, index=0):
        super().__init__()
